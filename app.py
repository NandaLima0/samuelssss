...
def finalizar_compra():
    ...
    try:
        cursor.execute('SELECT nome, preco, tipo FROM carrinho WHERE user_id = ?', (user_id,))
        ...
        with conn:
            ...
            cursor.execute('DELETE FROM carrinho WHERE user_id = ?', (user_id,))

        return jsonify({'status': 'success', 'message': 'Compra finalizada com sucesso.', 'total': total_compra})
